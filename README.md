...
- **Бот статистики Москвы** — Telegram-бот со статистикой mesh-сети Москвы. От @Owear002. *(публичный репозиторий не обнаружен)*
...
- **Нода на антенну** — Компактная нода Meshtastic, крепящаяся непосредственно на антенну. От @Zimati. *(публичный репозиторий не обнаружен)*

- **Meteobot868/434** — Метеостанция-нода на базе Meshtastic в диапазонах 868/434 МГц. От @SEW22914. *(публичный репозиторий не обнаружен)*
